...
<head>
    ...
    <body style="background-color: white;">
        <div id="loginbox" style=" margin-top: -100px;">				 <img src="img/logo_agropoda.png" alt="Logo">

            <form class="form" id="form1" method="get" action="Phps/log/Login2.php" style="background-color: white;">
