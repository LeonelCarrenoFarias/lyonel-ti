...
if($centro==0){
    $c1="SELECT * FROM `det_sal_materiales`";

}else {

    $c1="SELECT `Code`, `Id_Centro`, `Id_Det_Sal_Materiales`, `Detalle`, `Cantidad`, `Monto`, `Fecha_Salida`, `Estado` FROM `det_sal_materiales` WHERE `Id_Centro`=$centro";
}
...
class PDF1 extends FPDF{
    ...
    function header2($centro)
    {
        ...
        $this->SetY(83);
        $this->SetX(60);
        $this->Cell(190, 3,"Consolidado Centros de costo: $centro",0,0,"left");
    }
    function body1(){
