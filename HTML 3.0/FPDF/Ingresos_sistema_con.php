...
$c1="SELECT `Code`, `Id_Detalle_Material`, `Cantidad`, `Detalle`, `Medida`, `Stock_Optimo`, `Monto`, `Categoria`, `Fecha_Ingreso`, `documento_asoc`, `Estado` FROM `det_material` WHERE 1";
...
class PDF1 extends FPDF{
    ...
    function header2()
    {
        ...
        $this->SetY(83);
        $this->SetX(60);
        $this->Cell(190, 3,utf8_decode("Consolidado de INGRESOS AL SISTEMA 2021"),0,0,"left");
    }
    function body1(){
    ...
    function body2($q1){
        ...
        while($r=mysqli_fetch_row($q1)) {
            ...
            $this->SetY($y);
            $this->SetX(10);
            $this->Cell(16, 8, $r[2], 1, 0, "C");
            $this->SetX(26);
            $this->Cell(19, 8, $r[0], 1, 0, "C");
            $this->SetX(45);
            $this->Cell(20, 8, $r[8], 1, 0, "C");
            $this->SetX(65);
