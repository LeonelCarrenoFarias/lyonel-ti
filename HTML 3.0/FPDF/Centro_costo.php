...
if($centro===0){
    $c1 = "SELECT `Code`, `Id_Centro`, `Id_Det_Sal_Materiales`, `Detalle`, `Cantidad`, `Monto`, `Fecha_Salida`, `Estado` FROM `det_sal_materiales` WHERE `Fecha_Salida` BETWEEN '$fecha1' AND '$fecha2'";

}else {

    $c1 = "SELECT `Code`, `Id_Centro`, `Id_Det_Sal_Materiales`, `Detalle`, `Cantidad`, `Monto`, `Fecha_Salida`, `Estado` FROM `det_sal_materiales` WHERE `Fecha_Salida` BETWEEN '$fecha1' AND '$fecha2' AND `Id_Centro`=$centro";
}
...
class PDF1 extends FPDF{
    ...
    function header2($fecha1,$fecha2,$centro)
    {
        ...
        $this->SetY(83);
        $this->SetX(60);
        $this->Cell(190, 3,"Centro de costo N:$centro  $fecha1/$fecha2",0,0,"left");
    }
    function body1(){
