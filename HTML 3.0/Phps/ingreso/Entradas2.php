...
if($tipo===1){
            ...
            if($des==1){
                ...
                $tx2="UPDATE `inventario` SET `id_fabrica`='$code_fab',`cantidad`=$cant_final,`marca`='$marca',`ubicacion`='$seccion' WHERE `code`=$code";
                ...
                $tx3="INSERT INTO `inventario`(`code`,`id_fabrica`, `detalle`, `cantidad`, `marca`, `valor`, `ubicacion`) VALUES ('$code','$code_fab','$desc',$cant,'$marca',$precio,'$seccion')";
    ...
    $monto = $_GET['monto'];
        ...
        if ($qau4 == false) {
            ...
            if ($q3 == false || $q4==false) {
                ...
                echo "<script> alert('".$var."'); </script>";
                header('Location: ../Servicios/Servicios.php');
            }
    }
}else if($tipo===4){
