...
<div id="content">
  <div id="content-header">
    ...
    <h1>Entrada de un nuevo item</h1>
    </div>
          ...
          <div class="widget-content nopadding">
                    <form class="form-horizontal" method="GET" name="basic_validate" id="basic_validate" action="Entradas2.php">
                            <div class="control-group material herramienta arriendo servicio">
                                ...
                                <div class="controls">
                                    <input class="span2" value="<?php echo date('Y-m-d');; ?>" readonly required type="date" name="fecha" id="fecha">
                                </div>
                            </div>
                            ...
                            <div class="control-group material herramienta" id="cantidad">
                                ...
                                <div class="controls">
                                    <input class="span2 rst nw" readonly required type="number" minlength="1" min="0" name="cant" id="cant" >
                                </div>
                            ...
                            <div class="control-group  material herramienta ">
                                ...
                                <div class="controls" >
                                    <input class="rst span3 nw" type="number" readonly name="precio" min="0" id="precio"  required/>
                                </div>
                            </div>
                  ...
                  <div class="modal-body">
                      <form class="form-horizontal" method="GET" action="faster.php" >
                          ...
                          <div class="control-group">
                              <label class="control-label">Cantidad:</label>
                              <div class="controls">
                                  <input min="0" class="span5 " readonly required type="number" name="cant2" id="cant2" >
                              </div>
                          </div>
