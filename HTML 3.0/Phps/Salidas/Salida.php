        ...
        <div class="widget-box">
            <div class="widget-title">
              ...
              <table class="table table-bordered data-table ">
                ...
                <td class="center" >'.$r1[5].'</td>
                <td class="center" ><input class="span10 controls cantidad maximos" disabled type="number"></td>
                </tr>
                ';
                }
                          ...
                          <p id="contenido"><i class="icon icon-check"></i> </p>
                            ...
                            <form  method="get" action="salida_material.php">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="number" readonly class="span3" required id="canti"  name="canti" >
                                </div>
