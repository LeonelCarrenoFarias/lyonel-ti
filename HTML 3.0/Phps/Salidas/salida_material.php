...
if($stock_posterior>=0) {
    ...
    $tt = "INSERT INTO `det_sal_materiales`(`Code`, `Id_Centro`, `Id_Det_Sal_Materiales`, `Detalle`, `Cantidad`, `Monto`, `Fecha_Salida`, `Estado`) VALUES ($id,$centro,$id6,'$detalle',$cantidad,$monto,'$fecha',1)";
