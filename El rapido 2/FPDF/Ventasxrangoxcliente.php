...
if($centro === "0"){
    $c1 = "SELECT `Code`, `Id_Centro`, `Id_Det_Sal_Materiales`, `Detalle`, `Cantidad`, `Monto`, `Fecha_Salida`, `Estado` FROM `det_sal_materiales` WHERE `Fecha_Salida` BETWEEN '$fecha1' AND '$fecha2' ORDER BY `Fecha_Salida` ASC";

}else {

    $c1 = "SELECT `Code`, `Id_Centro`, `Id_Det_Sal_Materiales`, `Detalle`, `Cantidad`, `Monto`, `Fecha_Salida`, `Estado` FROM `det_sal_materiales` WHERE `Fecha_Salida` BETWEEN '$fecha1' AND '$fecha2' AND `Id_Centro`='$centro'  ORDER BY `Fecha_Salida`";
}
...
class PDF1 extends FPDF{
    ...
    function header2($fecha1,$fecha2,$centro)
    {
        $var="";
        if($centro === "0"){
            $var="TODOS";
        ...
        $this->SetY(83);
        $this->SetX(60);
        $this->Cell(190, 3,"Cliente N: $var  $fecha1 / $fecha2",0,0,"left");
    }
    function body1(){
    ...
    function body2($q1){
        ...
        $this->SetY(123);
        $this->SetX(26);
        $this->Cell(19, 12,utf8_decode("Cliente"),1,0,"C");
        $this->SetY(123);
        $this->SetX(45);
...
$pdf ->header2($fecha1,$fecha2,$centro);
