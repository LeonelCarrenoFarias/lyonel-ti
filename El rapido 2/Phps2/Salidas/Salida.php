...
<p style="font-size: 14px;">Modulo para registrar salidas desde el inventario.</p>
        <p><strong>Dato importante: </strong>La salida de elementos del inventario es individual. Debes seleccionar el check de la primera columna, en la fila del item a descontar. Luego ingresas la cantidad y presionas tabulador. El sistema te solicitará ingresar el cliente al cual esta asociada la extracción. </p><p><strong>Dato importante: </strong>Cada salida va asociada a un cliente. </p>
              ...
              <table class="table table-bordered data-table ">
                ...
                include_once '../connect/Connect.php';
                    ...
                    while($r1=mysqli_fetch_row($q1)){
                        ...
                        $aux1=floatval($r1[5]*1.19);
                        $aux2=intval(round($aux1*1.20));
                        echo'
                            <tr class="gradeX">
                ...
                <td class="center" style="text-align: right;">'.$aux2.'</td>
...
<br>
                            <form  method="get" action="salida_material.php">
                                ...
                                <div class="controls">
                                    <label for="centrocosto">Selecciona el cliente correspondiente:</label>
