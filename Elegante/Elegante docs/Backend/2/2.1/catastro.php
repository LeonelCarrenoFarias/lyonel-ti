            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-folder-open-o"></i><a href="catastro.php">Catastro</a></li>
                            <li><i class="fa fa-plus-square-o"></i><a href="../2.2/agregar_planta.php">Agregar plantación</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <div class="ui-typography">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="typo-headers">
                                            <h3 class="pb-2 display-4">Catastro de plantaciones</h3>
                                        </div>
                                    </div>
                                </div>

                                        <div class="card-body"><button style="float:right; margin-left: 10px;"  type="button" class="btn btn-primary"><i class="fa fa-print"></i>&nbsp; Imprimir

                                            </button> <button style="float:right;" type="button" onclick="location= '../2.2/agregar_planta.php'" class="btn btn-warning"><i class="fa fa-plus-circle"></i>&nbsp; Nueva plantación</button>
                                            <table class="table">
                                                <thead><tr><h3>Plantaciones</h3><a>(Pomacéas)</a><br><br></tr>
                                                
                                                <tr>
                                                    <th style = "text-align: left;">Cuartel</th>
                                                    <th style = "text-align: left;">Especie</th>
                                                    <th style = "text-align: left;">Año Plantación</th>
                                                    <th style = "text-align: left;">Variedad</th>
                                                    <th style = "text-align: left;">Patrón</th>
                                                    <th style = "text-align: left;">Hás</th>
                                                    <th style = "text-align: left;">Densidad (SH x EH)</th>
                                                    <th style = "text-align: left;">Plantas/Há</th>
                                                    <th style = "text-align: left;">Plantas</th>
                                                    <th style = "text-align: left;">Riego</th>
</tr>
                                                </thead>
                                                <tbody>
                                                ...
                                                $text1="SELECT `id_cuartel`, `id_cuaderno`, `especie`, `num_cuartel`, `riego`, `total_has` FROM `cuartel` WHERE `id_cuaderno`=$id_cuaderno";
                                                ...
                                                while($row=mysqli_fetch_row($querry1)) {
                                                    $text2 = "SELECT `id_plantacion`, `id_cuartel`, `año`, `variedad`, `patron`, `categoria`, `has`, `densidad`, `densidad2`, `plantas_ha`, `plantas` FROM `plantacion` WHERE `id_cuartel`=$row[0] AND `categoria`=1";
                                                    $querry2 = mysqli_query($dbc, $text2);

                                                    $cont = 0;


                                                    while ($rw = mysqli_fetch_row($querry2)) {
                                                        $aux1 = strval($rw[7]);
                                                        $aux2 = strval($rw[8]);
                                                        $aux3 = " X ";
                                                        $val = $aux1 . $aux3 . $aux2;
                                                      ...
                                                      ';
                                                        ...
                                                        if ($cont == 0) {
                                                            echo '      <th style = "text-align: left;" > ' . $row[3] . '</th >
                                                                 <th style = "text-align: left;" > ' . $row[2] . '</th >';
                                                        } else {
                                                        ...
                                                        echo '
                                                            <td style = "text-align: left;" > ' . $rw[2] . '</td >
                                                            <td style = "text-align: left;" > ' . $rw[3] . '</td >
                                                            <td style = "text-align: left;" >' . $rw[4] . '</td >
                                                            <td style = "text-align: left;" > ' . $rw[6] . '</td >
                                                            <td style = "text-align: left;" > ' . $val . '</td >
                                                            <td style = "text-align: left;" > ' . $rw[9] . '</td >
                                                            <td style = "text-align: left;" > ' . $rw[10] . '</td >
                                                            ';
                                                        if ($cont == 0) {
                                                    ...
                                                    if (mysqli_num_rows($querry2) > 0) {
                                                        ...
                                                        echo ' 
                                                            ...
                                                            <tr >
                                                                ...
                                                                <td style = "text-align: left;" ></td >
                                                                <td style = "text-align: left;" ></td >
                                                                <td style = "text-align: left; background-color: khaki;" ><strong>Total Hás:</strong></td >
                                                                <td style = "text-align: left; background-color: khaki;" ><strong>' . $row[5] . '</strong></td >
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        <thead><tr><h3>Plantaciones</h3><a>(Carozos)</a><br><br></tr>
                                        ...
                                        while($row=mysqli_fetch_row($querry1)){
                                            $text2="SELECT `id_plantacion`, `id_cuartel`, `año`, `variedad`, `patron`, `categoria`, `has`, `densidad`, `densidad2`, `plantas_ha`, `plantas` FROM `plantacion` WHERE `id_cuartel`=$row[0] AND `categoria`=2";
                                            $querry2=mysqli_query($dbc,$text2);
...
if(mysqli_num_rows($querry2)>0) {
    ...
    echo ' 
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        <thead><tr><h3>Plantaciones</h3><a>(Drupas)</a><br><br></tr>
                                        ...
                                        while($row=mysqli_fetch_row($querry1)){
                                            $text2="SELECT `id_plantacion`, `id_cuartel`, `año`, `variedad`, `patron`, `categoria`, `has`, `densidad`, `densidad2`, `plantas_ha`, `plantas` FROM `plantacion` WHERE `id_cuartel`=$row[0] AND `categoria`=3";
                                            $querry2=mysqli_query($dbc,$text2);
