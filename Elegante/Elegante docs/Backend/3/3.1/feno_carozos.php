        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-renren"></i><a href="feno_carozos.php">Carozos</a></li>
            ...
            <div class="ui-typography">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="mensajes"><div class="sufee-alert alert with-close alert-warning alert-dismissible fade show" >
                                <span class="badge badge-pill badge-warning" >Consejo</span>
                                Puedes restaurar la vista presionando el boton del menú (3 barritas horizontales)
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="typo-headers">
                                    <h3 class="pb-2 display-4">Fenología de los carozos</h3>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"><button style="float:right; margin-left: 10px;"  type="button" class="btn btn-primary"><i class="fa fa-print"></i>&nbsp; Imprimir</button>
                                <table class="table">
                                    <thead><tr><h3>Fenologías</h3><a>(Carozos)</a><br><br></tr>
                                    ...
                                    <tr>
                                        ...
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Yema hinchada</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Inicio__flor</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Plena__flor</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Caida- petalos</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Caida- chaquetas</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Crec._fruto</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Pre_cosecha</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Inicio-cosecha</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Fin-Cosecha</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Caídas 50%</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Caídas 100%</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                            ...
                                            if(mysqli_num_rows($qqe)>0) {
                                                ...
                                                while ($rr = mysqli_fetch_row($qqe)) {
                                                    ...
                                                    $text = "SELECT `yema_hinchada`, `inicio_flor`, `plena_flor`, `caida_petalos`, `caida_chaquetas`, `crec_fruto`, `precosecha`, `inicio_cosecha`, `termino_cosecha`, `50_caida`, `100_caida` FROM `feno_carozos` WHERE `id_plantacion`=$rr[1]";
                                        ...
                                        <div class="modal-dialog modal-sm" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal"  method="GET" action="editar_carozo.php">
                                                        <div class="has-warning form-group col-lg-12">
                                                            <input type="hidden" id="id" name="id"  class="form-control-success form-control">
                                                        </div>
                                                        <div class="has-warning form-group col-lg-12">
                                                            <label style="text-align: center;" for="cuartel" class="form-control-label">
                                                        ...
                                                        <div class="has-warning form-group col-lg-12">
                                                            <label style="text-align: center;" for="cuartel" class="form-control-label">
                                                                <strong>Inicio-flor</strong>
                                                            </label>
                                                            <input type="date" id="if" name="if" class="form-control-success form-control">
                                                        </div>
                                                        <div class="has-warning form-group col-lg-12">
                                                            <label for="cuartel" class="form-control-label">
                                                                <strong>Plena-flor</strong>
                                                            </label>
                                                            <input type="date" id="pf" name="pf"  class="form-control-success form-control">
                                                        </div>
                                                        <div class="has-warning form-group col-lg-12">
                                                            <label style="text-align: center;" for="cuartel" class="form-control-label">
                                                                <strong>Caída-petalos</strong>
                                                            </label>
                                                            <input type="date" id="cp"  name="cp"  class="form-control-success form-control">
                                                        </div>
                                                        <div class="has-warning form-group col-lg-12">
                                                            <label style="text-align: center;" for="cuartel" class="form-control-label">
                                                                <strong>Caida-chaquetas</strong>
                                                            </label>
                                                            <input type="date" id="cch" name="cch"  class="form-control-success form-control">
                                                        </div>
                                                        <div class="has-warning form-group col-lg-12">
                                                            <label style="text-align: center;" for="cuartel" class="form-control-label">
                                                                <strong>Crecimiento fruto</strong>
                                                            </label>
                                                            <input type="date" id="cf" name="cf"  class="form-control-success form-control">
                                                        </div>
                                                        <div class="has-warning form-group col-lg-12">
                                                            <label style="text-align: center;" for="cuartel" class="form-control-label">
                                                                <strong>Pre-cosecha</strong>
                                                            </label>
                                                            <input type="date" id="pc" name="pc"  class="form-control-success form-control">
                                                        </div>
