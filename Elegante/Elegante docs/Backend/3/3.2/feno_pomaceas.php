            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="menu-icon fa fa-apple"></i><a href="feno_pomaceas.php">Pomáceas</a></li>
                        <li><i class="menu-icon fa fa-thumbs-up"></i><a href="../3.3/feno_drupas.php">Drupas</a></li>
                    </ul>
                </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="mensajes"><div style="max-width: 65%" class="sufee-alert alert with-close alert-warning alert-dismissible fade show" >
                                ...
                                Puedes restaurar la vista con el boton del menú (3 barritas horizontales)
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="typo-headers">
                                    <h3 class="pb-2 display-4">Fenología de las pomáceas</h3>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"><button style="float:right; margin-right: 530px;"  type="button" class="btn btn-primary"><i class="fa fa-print"></i>&nbsp; Imprimir</button>
                                <table class="table">
                                    <thead><tr><h3>Fenologías</h3><a>(Pomacéas)</a><br><br></tr>
                                    ...
                                    <tr>
                                        ...
                                        <th style = "text-align: left; font-size: 14px; padding-right: 0;">Tipo/Variedad</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Yema_hinchada</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Puntas_verdes</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Rama_expuesto</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Botón_rosado</th>
                                        ...
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Inicio Caida_petalos</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Fin Caida_petalos</th>
                                        ...
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Amarillas_50%</th>
                                        <th style = "text-align: left; font-size: 14px; padding-right: 1px;">Caídas__50%</th>
                                    ...
                                    <?php
                                            ...
                                            $tet="SELECT `id_cuartel`,`id_plantacion`, `variedad` FROM `plantacion` WHERE `categoria`=1";
                                            ...
                                            if(mysqli_num_rows($qqe)>0) {
                                                ...
                                                while ($rr = mysqli_fetch_row($qqe)) {
                                                    ...
                                                    $text = "SELECT `yema_hinchada`, `puntas_verdes`, `ramillete_expuesto`, `boton_rosado`, `inicio_flor`, `plena_flor`, `fruto_cuajado`, `caida_petalos_ini`, `caida_petalos_fin`, `inicio_cosecha`, `termino_cosecha`, `50_amarilla`, `50_caida`, `100_caida` FROM `feno_pomaceas` WHERE `id_plantacion`=$rr[1]";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style = "text-align: center; font-size: 14px;" > ' . $rww[9] . '</td >
                                                        <td style = "text-align: center; font-size: 14px;" > ' . $rww[10] . '</td >
                                                        <td style = "text-align: center; font-size: 14px;" > ' . $rww[11] . '</td >
                                                        <td style = "text-align: center; font-size: 14px;" > ' . $rww[12] . '</td >
                                                        <td style = "text-align: center; font-size: 14px;" > ' . $rww[13] . '</td >
                                    ...
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal"  method="GET" action="editar_pomaceas.php">
                                                    ...
                                                    <div class="has-warning form-group col-lg-12">
                                                        <label style="text-align: center;" for="yh" class="form-control-label">
                                                            <strong>Yema hinchada</strong>
                                                        </label>
                                                        <input type="date" id="yh" name="yh"  class="form-control-success form-control">
                                                    </div>
                                                    ...
                                                    <div class="has-warning form-group col-lg-12">
                                                        <label style="text-align: center;" for="re" class="form-control-label">
                                                            <strong>Ramillete expuesto</strong>
                                                        </label>
                                                        <input type="date" id="re" name="re" class="form-control-success form-control">
                                                    </div>
                                                    <div class="has-warning form-group col-lg-12">
                                                        <label style="text-align: center;" for="br" class="form-control-label">
                                                            <strong>Botón rosado</strong>
                                                        </label>
                                                        <input type="date" id="br" name="br" class="form-control-success form-control">
                                                    </div>
                                                    ...
                                                    <div class="has-warning form-group col-lg-12">
                                                        <label style="text-align: center;" for="icp" class="form-control-label">
                                                            <strong>Inicio Caída de pétalos</strong>
                                                        </label>
                                                        <input type="date" id="icp"  name="icp"  class="form-control-success form-control">
                                                    </div>
                                                    <div class="has-warning form-group col-lg-12">
                                                        <label style="text-align: center;" for="fcp" class="form-control-label">
                                                            <strong>Fin Caída de pétalos</strong>
                                                        </label>
                                                        <input type="date" id="fcp" name="fcp"  class="form-control-success form-control">
                                                    </div>
                                                    <div class="has-warning form-group col-lg-12">
                                                    ...
                                                    <div class="has-warning form-group col-lg-12">
                                                        <label style="text-align: center;" for="50a" class="form-control-label">
                                                            <strong>50% Amarillas</strong>
                                                        </label>
                                                        <input type="date" id="50a" name="50a"  class="form-control-success form-control">
                                                    </div>
                                                    <div class="has-warning form-group col-lg-12">
        ...
        $(".editar").click(function (){
            ...
            $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        $("#icp").val(respuesta.cpi);
                        $("#fcp").val(respuesta.cpf);
                        $("#ic").val(respuesta.ic);
