                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li class="active"><i class="fa fa-puzzle-piece"></i><a href="inicio.php" >Datos Generales</a></li>
                    ...
                    <div class="ui-typography">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="typo-headers">
                                            <h3 class="pb-2 display-4">Datos generales</h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                $text="SELECT `rut_razon`, `nombre_predio`, `razon social`, `propietario`, `csg`, `telefono`, `correo`, `encargado_huerto`, `napas`, `profundidad` FROM `fundo` WHERE `rut_razon`=$rut";
                                $querry=mysqli_query($dbc,$text);



                                $text2="SELECT `id_exportadora`, `rut_razon`, `nombre_exportadora`, `ciudad` FROM `exportadora` WHERE `rut_razon`=$rut";
                                $querry2=mysqli_query($dbc,$text2);
                                if($querry2==true) {
                                    while ($row2 = mysqli_fetch_row($querry2)) {
                                        $exportadora = utf8_decode($row2[2]);
                                    }
                                }


                                $text3="SELECT `id_direccion`, `rut_razon`, `region`, `ciudad`, `comuna`, `localidad`, `gps1`, `gps2`, `numero` FROM `direccion` WHERE `rut_razon`=$rut";
                                $querry3=mysqli_query($dbc,$text3);
                                while($row3=mysqli_fetch_row($querry3)){
                                    $comuna_emp=utf8_decode($row3[4]);
                                    $localidad_emp=utf8_decode($row3[5]);
                                }
                                ...
                                if($querry==true){
                                    while($row=mysqli_fetch_row($querry)){
                                        ...
                                        $text4="SELECT `id_cuaderno`, `rut_razon`, `encargado` FROM `cuaderno` WHERE `rut_razon`=$rut";
                                        $querry4=mysqli_query($dbc,$text4);

                                        while($row4=mysqli_fetch_row($querry4)){
                                            $encargado2=$row4[2];
                                        }
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong class="card-title">Identificación General Del Predio</strong><button style="float:right; margin-left: 10px;"  type="button" class="btn btn-primary"><i class="fa fa-print"></i>&nbsp; Imprimir
                                        </button>
                                        </div>
                                        <div class="card-body">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;">'.utf8_encode($nom).'</td>
                                                
                                                </tr>
                                                <tr>
                                                    <th scope="row">Propietario</th>
                                                    <td style="text-align: right;">'.utf8_encode($dueño).'</td>
                                                   
                                                </tr>
                                                <tr>
                                                    <th scope="row">Razon social</th>
                                                    <td style="text-align: right;">'.utf8_encode($razon).'</td>
                                                
                                                </tr>
                                                 <tr>
                                                    <th scope="row">Rut razón</th>
                                                    <td style="text-align: right;">'.utf8_encode($rut).'</td>
                                                
                                                </tr>
                                                 <tr>
                                                    <th scope="row">Localidad/comuna</th>
                                                    <td style="text-align: right;">'.utf8_encode($localidad_emp).' / '.utf8_encode($comuna_emp).'</td>
                                                
                                                </tr>
                                                <tr>
                                                    <th scope="row">CSG</th>
                                                    <td style="text-align: right;">'.utf8_encode($csg).'</td>
                                                
                                                </tr>
                                                <tr>
                                                    <th scope="row">Telefono/email</th>
                                                    <td style="text-align: right;">'.utf8_encode($telefono).' / '.utf8_encode($correo).'</td>
                                                
                                                </tr>
                                                 <tr>
                                                    <th scope="row">Encargado huerto</th>
                                                    <td style="text-align: right;">'.utf8_encode($encargado).'</td>
                                                
                                                </tr>
                                                 <tr>
                                                    <th scope="row">Encargado cuaderno</th>
                                                    <td style="text-align: right;">'.utf8_encode($encargado2).'</td>
                                                
                                                </tr>
                                                 <tr>
                                                    <th scope="row">Empresa exportadora</th>
                                                    <td style="text-align: right;">'.utf8_encode($exportadora).'</td>
...
$text3="SELECT `id_superficie`, `id_cuaderno`, `ha_totales`, `ha_plantadas`, `ha_disponibles` FROM `superficie` WHERE `id_cuaderno`=$id_cuaderno";
$querry3=mysqli_query($dbc,$text3);
...
while($row=mysqli_fetch_row($querry3)){
 ...
 echo'
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong class="card-title">Descripción General Del Predio</strong>
                                            <button style="float:right; margin-left: 10px;"  type="button" class="btn btn-primary"><i class="fa fa-print"></i>&nbsp; Imprimir

                                        </button>
                                        </div>
                                        <div class="card-body">
                                            <table class="table">
                                                <thead><tr><h3>Superficie</h3></tr></thead><br>
                                                <tbody>

                                                <tr>
                                                    <th scope="row">Hectareas totales del predio</th>
                                                    <td style="text-align: right;">'.utf8_encode($h1).'</td>

                                                </tr>
                                                <tr>
                                                    <th scope="row">Hectareas plantadas</th>
                                                    <td style="text-align: right;">'.utf8_encode($h2).'</td>

                                                </tr>
                                                <tr>
                                                    <th scope="row">Hectareas disponibles</th>
                                                    <td style="text-align: right;">'.utf8_encode($h3).'</td>
...
$text5="SELECT `id_riego`, `id_cuaderno`, `canal`, `vertiente`, `pozo`, `noria`, `tranque`, `caudal1`, `caudal2`, `caudal3`, `caudal4`, `caudal5`, `obs1`, `obs2`, `obs3`, `obs4`, `obs5` FROM `agua_riego` WHERE `id_cuaderno`=$id_cuaderno";
$querry5=mysqli_query($dbc,$text5);

while($row5=mysqli_fetch_row($querry5)){
...
$caudal4=$row5[10];
$caudal5=$row5[11];
$obs1=utf8_decode($row5[12]);
$obs2=utf8_decode($row5[13]);
$obs3=utf8_decode($row5[14]);
$obs4=utf8_decode($row5[15]);
$obs5=utf8_decode($row5[16]);
...
function decision2($valor){
        ...
        return $des;
            ...
            echo'                            
                                        <div class="card-body">
                                            <table class="table">
                                                <thead><tr><h3>Agua de riego</h3></tr><br>
                                                
                                                <tr>
                                                <th>Fuente</th>
                                                <th style="text-align: center;">¿Aplica?    </th>
                                                <th style="text-align: center;">Caudal (Lts/seg.)</th>
                                                <th>Observación</th>
</tr>
                                                </thead>
                                                <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">'.decision($agua1).'</td>
                                                    <td style="text-align: center;">'.decision2($caudal1).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($obs1).'</td>

                                                </tr>
                                                 <tr>
                                                    <th style="text-align: left;">Vertiente</th>
                                                     <td style="text-align: center;">'.decision($agua2).'</td>
                                                    <td style="text-align: center;">'.decision2($caudal2).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($obs2).'</td>

                                                </tr>
                                                 <tr>
                                                    <th style="text-align: left;">Pozo</th>
                                                     <td style="text-align: center;">'.decision($agua3).'</td>
                                                    <td style="text-align: center;">'.decision2($caudal3).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($obs3).'</td>

                                                </tr>
                                                 <tr>
                                                    <th style="text-align: left;">Noria</th>
                                                     <td style="text-align: center;">'.decision($agua4).'</td>
                                                    <td style="text-align: center;">'.decision2($caudal4).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($obs4).'</td>

                                                </tr>
                                                 <tr>
                                                    <th style="text-align: left;">Tranque</th>
                                                     <td style="text-align: center;">'.decision($agua5).'</td>
                                                    <td style="text-align: center;">'.decision2($caudal5).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($obs5).'</td>
...
echo'                            
                                        <div class="card-body">
                                            <table class="table">
                                                <thead><tr><h3>Sistema de riego </h3><a>(Microaspersion, goteo, californiano, tendido, surcos, etc.)</a><br><br></tr>
                                                
                                                <tr>
                                                <th style = "text-align: left;" >Sistema de riego</th>
                                                <th style = "text-align: center;">Hectareas</th>
                                                <th style = "text-align: center;">Cuarteles</th>
                                                <th style = "text-align: center;">Fuente de agua</th>
</tr>
                                                </thead>
                                                <tbody>
';
...
$text6="SELECT `id_sistema`, `id_cuaderno`, `nombre_sistema`, `hectareas`, `cuarteles`, `fuente_agua` FROM `sistema_riego` WHERE `id_cuaderno`=$id_cuaderno";
$querry6=mysqli_query($dbc,$text6);
while($row6=mysqli_fetch_row($querry6)) {
    echo '
                                                <tr >
                                                    <th style = "text-align: left;" >'.$row6[2].'</th >
                                                    <td style = "text-align: center;" > '.$row6[3].'</td >
                                                    <td style = "text-align: center;" > '.$row6[4].'</td >
                                                    <td style = "text-align: center;" > '.$row6[5].'</td >
...
$text7="SELECT `id_pulverizacion`, `id_cuaderno`, `canal`, `vertiente`, `pozo`, `noria`, `tranque`, `obs1`, `obs2`, `obs3`, `obs4`, `obs5` FROM `pulverizaciones` WHERE `id_cuaderno`=$id_cuaderno";
$querry7=mysqli_query($dbc,$text7);



while($row5=mysqli_fetch_row($querry7)){
    ...
    $agu4=$row5[5];
    $agu5=$row5[6];
    $ob1=utf8_decode($row5[7]);
    $ob2=utf8_decode($row5[8]);
    $ob3=utf8_decode($row5[9]);
    $ob4=utf8_decode($row5[10]);
    $ob5=utf8_decode($row5[11]);


    function decision3($valor){
    ...
    echo'                            
                                        <div class="card-body">
                                            <table class="table">
                                                <thead><tr><h3>Fuente de pulverizaciones</h3></tr><br>
                                                ...
                                                <tr>
                                                    <th style="text-align: left;">Canal</th>
                                                    <td style="text-align: center;">'.decision3($agu1).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($ob1).'</td>
                                                </tr>
                                                 <tr>
                                                    <th style="text-align: left;">Vertiente</th>
                                                     <td style="text-align: center;">'.decision3($agu2).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($ob2).'</td>
                                                </tr>
                                                 <tr>
                                                    <th style="text-align: left;">Pozo</th>
                                                     <td style="text-align: center;">'.decision3($agu3).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($ob3).'</td>
                                                </tr>
                                                 <tr>
                                                    <th style="text-align: left;">Noria</th>
                                                     <td style="text-align: center;">'.decision3($agu4).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($ob4).'</td>
                                                </tr>
                                                 <tr>
                                                    <th style="text-align: left;">Tranque</th>
                                                     <td style="text-align: center;">'.decision3($agu5).'</td>
                                                    <td style="text-align: left;">'.utf8_encode($ob5).'</td>
                                                </tr>
