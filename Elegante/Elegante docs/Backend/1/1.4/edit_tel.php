            ...
            <div class="animated fadeIn">
                    ...
                    <div class="ui-typography">
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="typo-headers">
                                            <h3 class="pb-2 display-4">Editar telefonos</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <form action="save_edit_tel.php" method="GET" class="">

                                    <div class="card-header">
                                        <strong>Editar telefonos de emergencia</strong>
                                    </div>
                                            <div class="card-body">
                                                <table class="table">
                                                    <tbody>
        ...
        While($row3=mysqli_fetch_row($querry3)){
                                                    echo'
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td style="text-align: left;"><input required type="text" id="proveedor" name="proveedor" class="form-control" value="'.$row3[0].'"></td>
                                                           <td></td>
                                                        </tr>
                                                        
                                                        <tr>
                                                           <th style="text-align: left;">Telefono 1 proveedor</th>
                                                           <td style="text-align: left;"><input required type="number" id="tel1" name="tel1" class="form-control" value="'.$row3[2].'"></td>
                                                           <td style="text-align: left;"><input required type="text" id="prov1" name="prov1" class="form-control" value="'.$row3[1].'" maxlength="50"></td>
                                                        </tr>
                                                         <tr>
                                                           <th style="text-align: left;">Telefono 2 proveedor</th>
                                                           <td style="text-align: left;"><input required type="number" id="tel2" name="tel2" class="form-control" value="'.$row3[4].'"></td>
                                                           <td style="text-align: left;"><input required type="text" id="prov2" name="prov2"  class="form-control" value="'.$row3[3].'" maxlength="50"></td>
                                                        </tr>
                                                        
                                                        <tr>
                                                           <th style="text-align: left;">El telefono mas cercano esta ubicado en: </th>
                                                           <td style="text-align: left;"><input required type="text" id="cercano" name="cercano"  class="form-control" maxlength="50" value="'.$row3[5].'"></td>
                                                           <td></td>
                                                        </tr>
                                                         ...
                                                         <tr>
                                                          ...
                                                          <tr>
                                                           ...
                                                           <td style="text-align: left;"><input required type="number" maxlength="12" id="hosp" name="hosp" class="form-control" value="'.$row3[7].'"></td>
                                                           <td></td>
                                                        </tr>
                                                          <tr>
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td style="text-align: left;"><input required type="number" id="cituc" name="cituc" class="form-control" value="'.$row3[11].'"></td>
                                                           <td></td>
                                                        </tr>
                                                        <tr>
                                                           <th style="text-align: left;">Otro:</th>
                                                           <td style="text-align: left;"><input required type="text" id="otro" name="otro"  class="form-control" maxlength="50" value="'.$row3[12].'"></td>
                                                           <td></td>
                                                        </tr>
...
?>
                                                ...
                                                <br><div class="form-actions form-group"><button style="float: right; margin-left: 10px;" type="reset" class="btn btn-danger btn-sm">Borrar</button><button style="float: right" type="submit" class="btn btn-success btn-sm">Guardar</button></div>
                                            </div>
                                    </form>
