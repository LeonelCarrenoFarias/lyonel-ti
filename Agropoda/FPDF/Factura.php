...
class PDF1 extends FPDF{
    ...
    function header2($fact)
    {
        ...
        $this->SetY(60);
        $this->SetX(12);
        $this->Cell(190, 3,"N° DE DOCUMENTO DE INGRESO: $fact",0,0,"left");
        $this->SetY(65);
        $this->SetX(12);
        $this->Cell(190, 3,"NOTA: EL DOCUMENTO PUEDE SER FACTURA O GUIA DE DESPACHO.",0,0,"left");
        $this->SetY(73);
        $this->SetX(0);
        $this->SetFillColor(190, 220, 170);
        $this->Cell(220, 1,"",0,0,"left",true);
    ...
    function body1(){
        ...
        $this->SetY(68);
        $this->SetX(169);
        $this->Cell(30, 2,'Eduardo Meneses',0,"left");
        $this->SetY(74);
        $this->SetX(174);
