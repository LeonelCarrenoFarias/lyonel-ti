...
<div id="sidebar">
  <ul>
    ...
    <li ><a href="../Requisiciones/Solicitar.php"><i class="icon icon-columns"></i> <span>Nueva requisicion</span></a></li>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <select class="span3" id="informe" name="informe" required>
                                      ...
                                      <option value="1">Informe de ingresos al sistema.</option>
                                      <option value="2">Informe de salidas del sistema.</option>
                                      <option value="3">Informe por centro de costo</option>
                                      <option value="4">Informe de inventario</option>
                                  </select>
                                </div>
                            </div>
                        <div class="control-group">
                            <label class="control-label">Seleccione el centro de costo: </label>
                            <div class="controls">
