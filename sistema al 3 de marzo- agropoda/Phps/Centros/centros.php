...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Menú</a>
  <ul>
    ...
    <li ><a href="../Requisiciones/Solicitudes.php"><i class="icon icon-check"></i> <span>Requisiciones</span></a></li>
      ...
      <li class="active"><a title="Centros de costos"  href="centros.php"><i class="icon icon-check"></i> <span>Centros de costos</span></a></li>

  </ul>
</div>
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="../../index.php" title="Ir a Inicio" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="#" class="current">Centros de Costos</a> </div>
    <h1>Centros de costos registrados en el sistema</h1>
      <br>
  </div>
    <div class="container-fluid">      <p style="font-size: 14px;">Listado de los grupos en los cuales se cargan las salidas del sistema, obteniendo un informe concreto de gastos, y segmentado en base a nuestra necesidad.</p>
        <p style="font-size: 14px;"><strong>NOTA 1:</strong> Eliminar centros de costos puede perjudicar el buen funcionamiento del sistema, ya que NO podrás visualizar informes de gasto de este mismo.</p>
        <p style="font-size: 14px;"><strong>NOTA 1:</strong> Visualiza la inversión total presionando código del centro de costo.</p>

      <hr>
    <div class="span11">
    <div class="row-fluid">
      <div class="widget-content tab-content" style="margin-top: -50px;"> <button id="nuevo" style="float: right; margin: 0.3%;" class=" btn-danger btn-primary span2" data-dismiss="modal" data-toggle="modal" href="#myAlert2"><i style="margin-right: 10px;" class="icon-arrow-up"></i> Nuevo centro</button><br>
          <div class="widget-box">
            <div class="widget-title" style="display: flex"> <span class="icon-3x" style="margin-left: 2px;"><i class="icon-th"></i></span>
              <h4 style="margin-left: 5px; margin-right: 65%;">Centros de costo</h4>
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered data-table">
                ...
                <tr>
                  ...
                  <th style="font-size: 14px;">Nombre del centro</th>
                ...
                while($row=mysqli_fetch_row($querry)) {
                    ...
                    echo '
                            <tr class="gradeX">
                              <td class="center" style="font-size: 13px;"><a title="Consolidado de inversión" target="_blank" href="../../FPDF/Centro_costo_con.php?centrocosto=' . $id_soli . '">' . $id_soli . '</a></td>
...
?>
          ...
          <div id="myModal" class="modal hide " aria-hidden="true" style="display: none;" data-backdrop="static" data-keyboard="false">
              <div class="modal-header">
                  ...
                  <h3>Eliminar centro de costo</h3>
              </div>
              <div class="modal-body">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" name="basic_validate" id="basic_validate" method="GET" action="nuevo.php" >
                    ...
                    <div class="control-group material herramienta arriendo servicio" >
                        <label class="control-label" style="text-align: left">Nombre del centro</label>
                        <div class="controls">
        ...
        <div id="myModal2" class="modal hide" aria-hidden="true" style="display: none;" data-backdrop="static" data-keyboard="false">
            ...
            <div class="modal-body">
                <p>Centro de costo creado con éxito.</p>
            </div>
        </div>
