                                ...
                                <div class="widget-content nopadding">
                                      <table id="tabla1" class="table table-bordered data-table" ">
                                        ...
                                        <tr>
                                            ...
                                            <th style="font-size: 15px; text-align: left;">COD.</th>
                                        ...
                                        echo '<tr style="background-color: '.$color.'">
                                                    ...
                                                    <td style="text-align: center;"><a class="precio" data-toggle="modal" href="#myAlert" >' . $row[6] . '</a></td>
              ...
              <div class="modal-header">
                  ...
                  <div class="modal-body" style="text-align: center;">
                    ...
                    <img  id="imagen1" src="" />
                                    ...
                                    <div id="myAlert" data-controls-modal="myAlert" data-backdrop="static" data-keyboard="false"  class="modal hide " aria-hidden="true" style="display: none;">
                                        <div class="modal-header">
                                            <button data-dismiss="modal" class="close" type="button">X</button>
                                        ...
                                        <div class="modal-body" style="text-align: center; height: 80%;">
                                            ...
                                            <form >
                                                <div class="controls"">
                                                <h4 for="newubi" style="text-align: left;">Ingresa la nueva ubicación: </h4>
                                                <select  required id="newubi" name="newubi">
                                                    <option value="0">-----------------</option>
                                                    <?php
                                                    include '../connect/Connect.php';
                                                    $text="SELECT `id`, `id_bodega`, `nombre`, `estado` FROM `seccion_bod` WHERE 1";
                                                    $query=mysqli_query($dbc,$text);

                                                    $cont=0;
                                                    while($row=mysqli_fetch_row($query)){
                                                        $cont++;
                                                        echo '<option value="'.strtoupper($row[0]).'">'.$row[0].'</option>';
                                                    }
                                                    ?>
                                                </select>
                                        </div>
...
<script language="JavaScript">
    $( function() {
        ...
        $(".precio").click(function () {
            ...
            var valor_ant= $(this).closest("tr").find("td:eq(8)").text();

            $("#id").val(parseInt(id));
            $("#ubi").val(valor_ant);

            $("#id").prop('readonly',true);
            $("#ubi").prop('readonly',true);


            $("#newubi").focus();

            $("#newubi").change(function(){
                ...
                if(new_neto === 0) {
                    ...
                    $("#conf1").click(function () {
                        $.ajax({
                            type: "GET",
                            url: "modificar_ubicacion.php",
                            data: {"id":id, "new_neto":new_neto},
                            success: function (respuesta) {
                                if (respuesta.estado === "si") {
                                    alert("Ubicación modificada con éxito.");
                                    location.reload();
                                } else {
