...
if($tipo2==="1"){
            ...
            location.href ="../inventario/Stock.php";
            </script>';          
}elseif($tipo2==="2"){
     mysqli_close($dbc);
            echo '<script language="javascript">
            location.href ="../../Phps2/inventario/Stock.php";
            </script>';    
}elseif($tipo2==="3"){
     mysqli_close($dbc);
            echo '<script language="javascript">
            location.href ="../../Phps3/inventario/Stock.php";
            </script>';    
}
            ...
            mysqli_close($dbc);
            echo '<script language="javascript">
            alert("Error al iniciar sesión, los datos no existen.");
