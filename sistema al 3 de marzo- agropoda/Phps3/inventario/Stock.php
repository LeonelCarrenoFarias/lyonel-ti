                                ...
                                <div class="widget-content nopadding">
                                      <table id="tabla1" class="table table-bordered data-table" ">
                                        ...
                                        echo '<tr style="background-color: '.$color.'">
                                                    <td style="text-align: center"><button disabled class="codigos"  data-toggle="modal" href="#myModal"><i class="icon icon-print icon-large" ></i></button></td>
                                                    <td>' . $row[0] . '</td>
                                                    <td>' . $row[1] . '</td>
...
<script>
    ...
    $(document).ready(function () {
       ...
       $(".codigos").click(function(){
            ...
            $("#imagen1").prop("src","https://barcode.tec-it.com/barcode.ashx?data=00000"+valor+"&code=Code128&multiplebarcodes=false&translate-esc=false&unit=Fit&dpi=96&imagetype=Gif&rotation=0&color=%23000000&bgcolor=%23ffffff&codepage=Default&qunit=Mm&quiet=0&hidehrt=False");
       }); 
